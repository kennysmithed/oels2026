...
//Bit of html formatting in this one - a header and some left-aligning and padding of the
//instructions, otherwise it is centered and pressed hard against the window edge, 
//which I think is hard to read. Note that I have to use a \ to insert a new line within 
//the paragraph text - this helps readability for humans.
var consent_screen = {
