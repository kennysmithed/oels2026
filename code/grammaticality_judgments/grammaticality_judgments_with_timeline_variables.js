...
// The sentences we want to test - each is labelled as sentence
var sentences = [
  { sentence: "Where did Blake buy the hat?" }, //Filler sentence, grammatical
  { sentence: "What did you claim that Blake bought?" }, //Complex NP Island Effect, control
  { sentence: "What did you make the claim that Blake bought?" }, //Complex NP Island Effect, violation
  { sentence: "Did where Blake buy the hat?" }, //Filler sentence, ungrammatical
];

// The general format for a judgment trial - note the use of jsPsych.timelineVariable
// for the stimulus parameter, which will allow us to retrieve the sentence values from 
// our sentences variable
var judgment_trial = {
...
// Stitch the two together - use the sentences variable for the timeline_variables
