...
Your experiment URL will begin something like https://jspsychlearning.ppls.ed.ac.uk/~s123456/ where the thing at the end is your student number (if it doesn't look like this you have done something wrong!). In principle we could use this to figure out who you are, but we will not do this. The logistics of setting up extra anonymous accounts is too complex and not worth the effort given that we have no interest in de-anonymising these! The thing we mostly want to avoid is people putting their actual name on their assignment, which happens more than you might think. So don't do that.
