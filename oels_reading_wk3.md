...
As you read this paper make notes of any questions, criticisms or ideas it gives you, and I'll leave time in the Monday lecture slot so we can discuss these in class. You can raise these in class, or flag them up using the pre-lecture questions form on Learn.
